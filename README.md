...
> An open protocol that lets any AI agent discover, request, and use licensed items from any other AI agent — with machine-readable terms and a status lifecycle.
